...
/datum/loadout_item/suit/security_jacket
	...
	restricted_roles = list(JOB_HEAD_OF_SECURITY, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE) //BUBBER EDIT
...
/datum/loadout_item/suit/labcoat_highvis
	...
	restricted_roles = list(JOB_CHIEF_MEDICAL_OFFICER, JOB_PARAMEDIC, JOB_ATMOSPHERIC_TECHNICIAN, JOB_DETECTIVE, JOB_CHEMIST) //BUBBER EDIT
