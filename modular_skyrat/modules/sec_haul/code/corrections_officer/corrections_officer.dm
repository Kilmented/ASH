...
/datum/outfit/job/corrections_officer
	...
	backpack_contents = list(/obj/item/melee/baton/security/loaded, /obj/item/restraints/handcuffs = 2, /obj/item/clothing/mask/whistle, /obj/item/gun/energy/disabler)
